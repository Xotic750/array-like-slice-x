...
describe('arrayLikeSlice', function () {
  ...
  itHasDocumentElement('works with DOM nodes', function () {
    ...
    expect(arrayLikeSlice(fragment.childNodes)).toEqual(expectedDOM);
